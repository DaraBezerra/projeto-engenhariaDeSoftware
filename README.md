...
* **Kanban**
  ...
  * Organização das tarefas em colunas (To Do, In Progress, Done)

---

## 🔗 Links do Projeto

* 📌 Product Backlog: (https://github.com/DaraBezerra/projeto-engenhariaDeSoftware/issues)
* ⚡ Sprint Backlog: (https://github.com/DaraBezerra/projeto-engenhariaDeSoftware/projects?query=is%3Aopen)
* 📊 Kanban: (https://github.com/users/DaraBezerra/projects/1)
...
hq/
│
├── imagens/        # Artes geradas por IA
├── roteiro/        # Roteiro da história
